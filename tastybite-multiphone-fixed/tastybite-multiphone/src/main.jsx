...
const demoStaff = [
  { id: "s1", name: "Chef Arif", role: "Head Chef", email: "arif@tastybite.local", salary: 2400, hours: "9:00 AM - 6:00 PM", days: "Mon-Sat" },
  { id: "s2", name: "Riya", role: "Waiter", email: "riya@tastybite.local", salary: 1400, hours: "10:00 AM - 7:00 PM", days: "Mon-Sat" },
  { id: "s3", name: "Sam", role: "Waiter", email: "sam@tastybite.local", salary: 1400, hours: "1:00 PM - 10:00 PM", days: "Tue-Sun" },
  { id: "s4", name: "Priya", role: "Sous Chef", email: "priya@tastybite.local", salary: 1900, hours: "9:00 AM - 6:00 PM", days: "Mon-Sat" },
];
...
function App() {
  ...
  return <div className="app-shell">
    ...
    {role === "admin" && <Admin orders={orders} tables={tables} menu={menu} onLogout={logout} staff={staff} setStaff={setStaff} reviews={reviews} updateTable={updateTable} addMenuItem={addMenuItem} updateMenuItem={updateMenuItem} deleteMenuItem={deleteMenuItem} />}
  </div>;
}
...
function Admin({orders,tables,menu,onLogout,staff=[],setStaff,reviews=[],updateTable,addMenuItem,updateMenuItem,deleteMenuItem}) {
  const [newStaff, setNewStaff] = useState({ name: "", role: "", email: "", salary: "", hours: "", days: "" });
  const [editingStaffId, setEditingStaffId] = useState(null);
  const [editingMenuId, setEditingMenuId] = useState(null);
  const [newMenuItem, setNewMenuItem] = useState({ name: "", category: "", price: "", description: "" });
  const patchStaff = (id, field, value) => setStaff && setStaff(prev => prev.map(s => s.id === id ? { ...s, [field]: field === "salary" ? Number(value) || 0 : value } : s));
  ...
  const addStaffMember = () => {
    ...
    setNewStaff({ name: "", role: "", email: "", salary: "", hours: "", days: "" });
  };
