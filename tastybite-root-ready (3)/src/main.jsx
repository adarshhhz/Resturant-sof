...
function SideNav({ role = "admin", onLogout, active = 0, onNavigate }) {
  const items = role === "kitchen" ? [["home","Kitchen Dashboard"],["orders","New Orders"],["clock","In Progress"],["check","Ready"],["orders","Completed"],["history","Orders History"],["box","Kitchen Stations"],["settings","Settings"]]
    ...
    : [["home","Dashboard"],["orders","Orders"],["menu","Menu Management"],["box","Inventory"],["box","Purchases"],["box","Suppliers"],["box","Expenses"],["users","Staff Management"],["box","Tables"],["users","Customers"],["chart","Reports"],["settings","Settings"]];
...
function Admin({orders,tables,menu,onLogout}) {
  ...
  const adminSections = {1:"Orders",2:"Menu Management",3:"Inventory",4:"Purchases",5:"Suppliers",6:"Expenses",7:"Staff Management",9:"Customers",10:"Reports",11:"Settings"};
